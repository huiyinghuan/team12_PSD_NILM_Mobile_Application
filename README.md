...
- Open a terminal, change to the project directory for SMART OASIS and run:
...
- Open up Podfile with any text editor and comment out the line with platform: ios using a '#'

![comment out](readme_images/platformios.jpg)
